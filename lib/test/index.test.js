...
describe('fetch', () => __awaiter(this, void 0, void 0, function* () {
    describe('id not found', () => {
        test('catch error', () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield Tart.fetch({ path: 'user', id: 'id' });
            }
            catch (error) {
    ...
    describe('exist id', () => __awaiter(this, void 0, void 0, function* () {
        test('fetched', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield Tart.fetch(user);
...
describe('Snapshot', () => __awaiter(this, void 0, void 0, function* () {
    ...
    describe('save', () => {
        test('save succeeded', () => __awaiter(this, void 0, void 0, function* () {
            const data = { name: 'test' };
            const user = Tart.Snapshot.makeNotSavedSnapshot('user', data);
            yield user.save();
            const savedUser = yield Tart.fetch(user.ref);
    ...
    describe('saveWithBatch', () => {
        ...
        describe('multiple saveWithBatch', () => {
            test('save succeeded', () => __awaiter(this, void 0, void 0, function* () {
                ...
                expect(savedUser.data).toEqual(user.data);
                expect(savedUser.ref.path).toEqual(user.ref.path);
                const savedGame = yield Tart.fetch(game.ref);
    ...
    describe('setReferenceCollectionWithBatch', () => {
        test('save succeeded', () => __awaiter(this, void 0, void 0, function* () {
            ...
            expect(savedUser.data).toEqual(user.data);
            expect(savedUser.ref.path).toEqual(user.ref.path);
            const gameQuerySnapshot = yield savedUser.ref.collection('games').get();
            const savedGame = yield Tart.fetch({ path: 'game', id: gameQuerySnapshot.docs[0].id });
            expect(savedGame.data).toEqual(game.data);
            expect(savedGame.ref.path).toEqual(game.ref.path);
        }));
    });
    describe('update', () => {
        test('update succeeded', () => __awaiter(this, void 0, void 0, function* () {
            const data = { name: 'test' };
            const user = Tart.Snapshot.makeNotSavedSnapshot('user', data);
            yield user.save();
            yield user.update({ name: 'new name' });
            const savedUser = yield Tart.fetch(user.ref);
    ...
    describe('updateWithBatch', () => {
        test('update succeeded', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield user.save();
            const batch = admin.firestore().batch();
            yield user.updateWithBatch(batch, { name: 'new name' });
            yield batch.commit();
            const savedUser = yield Tart.fetch(user.ref);
            expect(savedUser.data.name).toEqual('new name');
            expect(savedUser.ref.path).toEqual(user.ref.path);
